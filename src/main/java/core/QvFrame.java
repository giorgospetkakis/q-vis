...
public class QvFrame extends JFrame{
	...
	private void initGL() {
		...
		LOG.info("Initialized OpenGL Capabilities: "
				+ "Bit-Depth " + QvFrameProperties.BIT_DEPTH);
	}
	...
	private void initFrame() {
		...
		LOG.info("Initialized HrdyFrame with"
				+ " title " + QvFrameProperties.TITLE
				+ " and size " + QvFrameProperties.WIDTH + ", " + QvFrameProperties.HEIGHT
				+ " at location " + QvFrameProperties.LOCATION.toString());
	}
}
